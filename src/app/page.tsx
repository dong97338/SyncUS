...
const Frame: FunctionComponent = () => {
	...
	return (
		<div className="w-full relative rounded-[30px] bg-flowkit-white h-[812px] overflow-hidden text-left text-xs text-flowkit-white font-pretendard">
			<div className="absolute top-[378px] left-[267px] w-[82px] h-3" />
			<img className="relative w-0 h-0" alt="" src="/union.svg" />
			<div className="absolute top-[728px] left-[0px] shadow-[0px_-4px_10px_rgba(0,_0,_0,_0.1)] bg-flowkit-white w-[375px] flex flex-row items-center justify-center pt-0 px-5 pb-6 box-border gap-[56px] text-type-base">
			...
			<img
				className="absolute top-[53px] left-[323px] w-8 h-8 object-cover"
				alt=""
				src="/group-8@2x.png"
			/>
			<img
				className="absolute top-[53px] left-[274px] w-8 h-8"
				alt=""
				src="/group-9.svg"
			/>
			<div className="absolute top-[96px] left-[21px] rounded-xl bg-cornflowerblue-100 flex flex-row items-start justify-start py-1.5 px-3.5">
				<div className="relative font-semibold">기획자</div>
			</div>
			<div className="absolute top-[134px] left-[27px] text-lg tracking-[-0.02em] font-semibold text-gray">
				<p className="[margin-block-start:0] [margin-block-end:7px]">
					이재윤님,
				</p>
				<p className="m-0">좋은 아침입니다 :)</p>
			</div>
			<div className="absolute top-[585px] left-[27px] text-base tracking-[-0.02em] font-semibold text-gray">
				어떻게 하면 좋을지 물어봐요
			</div>
			<div className="absolute top-[223px] left-[calc(50%_-_178.5px)] w-[358px] h-[309px]">
				...
				<div className="absolute top-[229px] left-[calc(50%_-_179px)] w-[358px] h-20 overflow-hidden text-base">
					<img
						...
						src="/group-6.svg"
					/>
					<div className="absolute top-[10px] left-[27px] rounded-xl bg-cornflowerblue-200 w-[304px] h-[52px] flex flex-row items-center justify-center py-3 px-8 box-border">
